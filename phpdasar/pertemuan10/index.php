...
<body>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="name" id="name" value="<?= $itemToEdit['name']; ?>">
    </div>
    <div class="form-group">
        <label for="type">Tipe:</label>
        <input type="text" class="form-control" name="type" id="type" value="<?= $itemToEdit['type']; ?>">
    </div>
    <!-- Tambahkan input untuk kolom lain yang ingin diubah dengan div form-group -->
    <div class="form-group">
